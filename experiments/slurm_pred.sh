...
INPUT_IMAGE=/home/blao/rgz_resnet_fpn/data/testD1new/FIRSTJ163824.1+525151_logminmax_new.png  #FIRSTJ170731.3+535955_logminmax_new.png #/o9000/MWA/GLEAM/G0008_images/deep_learn/data/GLEAM20130810_1060208376_200-231MHz_1680_1456.png #/home/blao/rgz_resnet_fpn/data/testD1new/FIRSTJ163826.9+343128_logminmax_new.png
python train.py --predict $INPUT_IMAGE  \
        --load /home/blao/rgz_resnet_fpn/train_log/10468/model-320000 \
	...
	TEST.RESULT_SCORE_THRESH_VIS=0.5 \
	TEST.RESULT_SCORE_THRESH=0.5 \
        DATA.NUM_CATEGORY=4 \

...
colors_BGR = {'cs': (0,0,255), 'fr1': (255,0,0), 'fr2': (0,255,255), 'core_jet': (0,128,0)} 
def draw_annotation(img, boxes, klass, is_crowd=None):
    ...
    #logger.info(cfg.DATA.CLASS_NAMES[cls])
...
def draw_final_outputs(img, results):
    ...
    ret = viz.draw_boxes(img, boxes, tags, Source_finding=False)
